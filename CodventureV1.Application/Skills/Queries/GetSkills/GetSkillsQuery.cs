...
public sealed class Handler(IQueryRepositoryFactory queryRepositoryFactory, IMapper mapper) : GetWithPaginationHandler<int, Skill, GetSkillsQuery, SkillDto>(queryRepositoryFactory, mapper)
{
}
